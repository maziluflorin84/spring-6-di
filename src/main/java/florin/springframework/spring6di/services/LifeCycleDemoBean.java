...
import florin.springframework.spring6di.controllers.MyController;
...
public class LifeCycleDemoBean implements InitializingBean, DisposableBean, BeanNameAware, BeanFactoryAware,
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        System.out.println("## 4 ApplicationContextAware - Application Context has veen set");
    }

    @PostConstruct
    public void postConstruct() {
        System.out.println("## 5 postConstruct - The Post Construct annotated method has veen called");
    }
